...
```{r}
#Extracting sample data from coumn names and adding them to a dataframe
...
```{r}
limma::plotMA(log2(filtered_data[,c(2,3)]), ylab="M - ratio log expression", 
       main="Primary (20A) versus Recurrent (20B) Tumor")
```
